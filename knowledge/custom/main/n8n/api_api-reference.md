 ...
 * [ Installation and management ](https://docs.n8n.io/integrations/community-nodes/installation/)
 ...
 * [ Choose node file structure ](https://docs.n8n.io/integrations/creating-nodes/build/reference/node-file-structure/)
 * [ Base files ](https://docs.n8n.io/integrations/creating-nodes/build/reference/node-base-files/)
Base files 
 ...
 * [ Test your node ](https://docs.n8n.io/integrations/creating-nodes/test/)
Test your node 
 ...
 * [ Google Cloud ](https://docs.n8n.io/hosting/installation/server-setups/google-cloud/)
 ...
 * [ Configuration examples ](https://docs.n8n.io/hosting/configuration/configuration-examples/)
 ...
 * Built in methods and variables Built in methods and variables 
 ...
 * [ Built-in methods and variables examples ](https://docs.n8n.io/code/cookbook/builtin/)
 ...
 * [ Expressions ](https://docs.n8n.io/code/cookbook/expressions/)
Expressions 
 ...
 * [ Code node ](https://docs.n8n.io/code/cookbook/code-node/)
Code node 
 ...
 * [ HTTP Request node ](https://docs.n8n.io/code/cookbook/http-node/)
HTTP Request node 
 * [ Pagination ](https://docs.n8n.io/code/cookbook/http-node/pagination/)
 * [ Advanced AI ](https://docs.n8n.io/advanced-ai/)
Advanced AI 
 * [ Tutorial: Build an AI workflow in n8n ](https://docs.n8n.io/advanced-ai/intro-tutorial/)
 * LangChain in n8n LangChain in n8n 
 ...
 * [ Using the API playground ](https://docs.n8n.io/api/using-api-playground/)
...
E-mail: hello@n8n.io License: [Sustainable Use License](https://github.com/n8n-io/n8n/blob/master/LICENSE.md) [Terms of Service](https://n8n.io/legal/terms)
n8n Public API
[n8n API documentation](https://docs.n8n.io/api/)
## [](https://docs.n8n.io/api/api-reference/#tag/User)User
Operations about users
## [](https://docs.n8n.io/api/api-reference/#tag/User/paths/~1users/get)Retrieve all users 
...
## [](https://docs.n8n.io/api/api-reference/#tag/User/paths/~1users/post)Create multiple users 
...
## [](https://docs.n8n.io/api/api-reference/#tag/User/paths/~1users~1{id}/get)Get user by ID/Email 
...
## [](https://docs.n8n.io/api/api-reference/#tag/User/paths/~1users~1{id}/delete)Delete a user 
...
delete/users/{id}
https://docs.n8n.io/api/v1/users/{id}
## [](https://docs.n8n.io/api/api-reference/#tag/User/paths/~1users~1{id}~1role/patch)Change a user's global role 
...
## [](https://docs.n8n.io/api/api-reference/#tag/Audit)Audit
Operations about security audit
## [](https://docs.n8n.io/api/api-reference/#tag/Audit/paths/~1audit/post)Generate an audit 
 ...
 * "packageUrl": "https://www.npmjs.com/package/n8n-nodes-test[](https://www.npmjs.com/package/n8n-nodes-test)"
}
]
}
]
...
## [](https://docs.n8n.io/api/api-reference/#tag/Execution)Execution
Operations about executions
## [](https://docs.n8n.io/api/api-reference/#tag/Execution/paths/~1executions/get)Retrieve all executions 
...
## [](https://docs.n8n.io/api/api-reference/#tag/Execution/paths/~1executions~1{id}/get)Retrieve an execution 
...
## [](https://docs.n8n.io/api/api-reference/#tag/Execution/paths/~1executions~1{id}/delete)Delete an execution 
...
## [](https://docs.n8n.io/api/api-reference/#tag/Workflow)Workflow
Operations about workflows
## [](https://docs.n8n.io/api/api-reference/#tag/Workflow/paths/~1workflows/post)Create a workflow 
...
## [](https://docs.n8n.io/api/api-reference/#tag/Workflow/paths/~1workflows/get)Retrieve all workflows 
...
## [](https://docs.n8n.io/api/api-reference/#tag/Workflow/paths/~1workflows~1{id}/get)Retrieves a workflow 
...
## [](https://docs.n8n.io/api/api-reference/#tag/Workflow/paths/~1workflows~1{id}/delete)Delete a workflow 
Deletes a workflow.
##### Authorizations:
_ApiKeyAuth_
##### path Parameters
...
## [](https://docs.n8n.io/api/api-reference/#tag/Workflow/paths/~1workflows~1{id}/put)Update a workflow 
Update a workflow.
##### Authorizations:
_ApiKeyAuth_
##### path Parameters
...
## [](https://docs.n8n.io/api/api-reference/#tag/Workflow/paths/~1workflows~1{id}~1activate/post)Activate a workflow 
Active a workflow.
##### Authorizations:
_ApiKeyAuth_
##### path Parameters
...
## [](https://docs.n8n.io/api/api-reference/#tag/Workflow/paths/~1workflows~1{id}~1deactivate/post)Deactivate a workflow 
...
## [](https://docs.n8n.io/api/api-reference/#tag/Workflow/paths/~1workflows~1{id}~1transfer/put)Transfer a workflow to another project. 
...
## [](https://docs.n8n.io/api/api-reference/#tag/Workflow/paths/~1credentials~1{id}~1transfer/put)Transfer a credential to another project. 
...
## [](https://docs.n8n.io/api/api-reference/#tag/Workflow/paths/~1workflows~1{id}~1tags/get)Get workflow tags 
Get workflow tags.
##### Authorizations:
_ApiKeyAuth_
##### path Parameters
...
## [](https://docs.n8n.io/api/api-reference/#tag/Workflow/paths/~1workflows~1{id}~1tags/put)Update tags of a workflow 
...
## [](https://docs.n8n.io/api/api-reference/#tag/Credential)Credential
Operations about credentials
## [](https://docs.n8n.io/api/api-reference/#tag/Credential/paths/~1credentials/post)Create a credential 
...
## [](https://docs.n8n.io/api/api-reference/#tag/Credential/operation/deleteCredential)Delete credential by ID 
...
## [](https://docs.n8n.io/api/api-reference/#tag/Credential/paths/~1credentials~1schema~1{credentialTypeName}/get)Show credential data schema 
##### Authorizations:
_ApiKeyAuth_
##### path Parameters
...
## [](https://docs.n8n.io/api/api-reference/#tag/Tags)Tags
Operations about tags
## [](https://docs.n8n.io/api/api-reference/#tag/Tags/paths/~1tags/post)Create a tag 
...
## [](https://docs.n8n.io/api/api-reference/#tag/Tags/paths/~1tags/get)Retrieve all tags 
...
## [](https://docs.n8n.io/api/api-reference/#tag/Tags/paths/~1tags~1{id}/get)Retrieves a tag 
Retrieves a tag.
##### Authorizations:
_ApiKeyAuth_
##### path Parameters
...
## [](https://docs.n8n.io/api/api-reference/#tag/Tags/paths/~1tags~1{id}/delete)Delete a tag 
Deletes a tag.
##### Authorizations:
_ApiKeyAuth_
##### path Parameters
...
## [](https://docs.n8n.io/api/api-reference/#tag/Tags/paths/~1tags~1{id}/put)Update a tag 
Update a tag.
##### Authorizations:
_ApiKeyAuth_
##### path Parameters
...
## [](https://docs.n8n.io/api/api-reference/#tag/SourceControl)SourceControl
Operations about source control
## [](https://docs.n8n.io/api/api-reference/#tag/SourceControl/paths/~1source-control~1pull/post)Pull changes from the remote repository 
...
## [](https://docs.n8n.io/api/api-reference/#tag/Variables)Variables
Operations about variables
## [](https://docs.n8n.io/api/api-reference/#tag/Variables/paths/~1variables/post)Create a variable 
...
## [](https://docs.n8n.io/api/api-reference/#tag/Variables/paths/~1variables/get)Retrieve variables 
...
## [](https://docs.n8n.io/api/api-reference/#tag/Variables/paths/~1variables~1{id}/delete)Delete a variable 
...
## [](https://docs.n8n.io/api/api-reference/#tag/Variables/paths/~1variables~1{id}/put)Update a variable 
...
## [](https://docs.n8n.io/api/api-reference/#tag/Projects)Projects
Operations about projects
## [](https://docs.n8n.io/api/api-reference/#tag/Projects/paths/~1projects/post)Create a project 
...
## [](https://docs.n8n.io/api/api-reference/#tag/Projects/paths/~1projects/get)Retrieve projects 
...
## [](https://docs.n8n.io/api/api-reference/#tag/Projects/paths/~1projects~1{projectId}/delete)Delete a project 
...
## [](https://docs.n8n.io/api/api-reference/#tag/Projects/paths/~1projects~1{projectId}/put)Update a project 
Update a project.
##### Authorizations:
_ApiKeyAuth_
##### path Parameters
...
## [](https://docs.n8n.io/api/api-reference/#tag/Projects/paths/~1projects~1{projectId}~1users/post)Add one or more users to a project 
...
relationsrequired| Array of objects A list of userIds and roles to add to the project. 
---|--- 
### Responses
**201**
Operation successful.
...
## [](https://docs.n8n.io/api/api-reference/#tag/Projects/paths/~1projects~1{projectId}~1users~1{userId}/delete)Delete a user from a project 
...
projectIdrequired| string The ID of the project. 
---|--- 
userIdrequired| string The ID of the user. 
### Responses
**204**
Operation successful.
**401**
...
## [](https://docs.n8n.io/api/api-reference/#tag/Projects/paths/~1projects~1{projectId}~1users~1{userId}/patch)Change a user's role in a project 
...
rolerequired| string The role assigned to the user in the project. 
---|--- 
### Responses
**204**
Operation successful.
...
Back to top [ Previous Using the API playground ](https://docs.n8n.io/api/using-api-playground/) [ Next n8n Embed Documentation and Guides ](https://docs.n8n.io/embed/)
...
[Pricing ↗](https://n8n.io/pricing/) [Workflow templates ↗](https://n8n.io/workflows/) [Feature highlights ↗](https://n8n.io/features/) [AI highlights ↗](https://n8n.io/ai/)
[Change cookie settings](https://docs.n8n.io/api/api-reference/#__consent)
Made with [ Material for MkDocs Insiders ](https://squidfunk.github.io/mkdocs-material/)
#### Cookie consent
We use cookies and other tracking technologies to improve your browsing experience, to analyze our website traffic, assist our marketing efforts and to understand where our visitors are coming from. [](https://n8n.io/legal/)
 * Google Analytics 
 * GitHub 
