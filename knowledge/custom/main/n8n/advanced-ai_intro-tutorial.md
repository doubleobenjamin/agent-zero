 ...
 * [ Advanced AI ](https://docs.n8n.io/advanced-ai/)
Advanced AI 
 * Tutorial: Build an AI workflow in n8n [ Tutorial: Build an AI workflow in n8n ](https://docs.n8n.io/advanced-ai/intro-tutorial/) Table of contents 
 * [ What you will need ](https://docs.n8n.io/advanced-ai/intro-tutorial/#what-you-will-need)
 * [ What you will learn ](https://docs.n8n.io/advanced-ai/intro-tutorial/#what-you-will-learn)
 * [ AI concepts in n8n ](https://docs.n8n.io/advanced-ai/intro-tutorial/#ai-concepts-in-n8n)
 * [ 1. Create a new workflow ](https://docs.n8n.io/advanced-ai/intro-tutorial/#1-create-a-new-workflow)
 * [ 2. Add a trigger node ](https://docs.n8n.io/advanced-ai/intro-tutorial/#2-add-a-trigger-node)
 * [ 3. Add an AI Agent Node ](https://docs.n8n.io/advanced-ai/intro-tutorial/#3-add-an-ai-agent-node)
 * [ 4. Configure the node ](https://docs.n8n.io/advanced-ai/intro-tutorial/#4-configure-the-node)
 * [ 5. Add credentials (if needed) ](https://docs.n8n.io/advanced-ai/intro-tutorial/#5-add-credentials-if-needed)
 * [ 6. Test the node ](https://docs.n8n.io/advanced-ai/intro-tutorial/#6-test-the-node)
 * [ 7. Changing the prompt ](https://docs.n8n.io/advanced-ai/intro-tutorial/#7-changing-the-prompt)
 * [ 8. Adding persistence ](https://docs.n8n.io/advanced-ai/intro-tutorial/#8-adding-persistence)
 * [ 9. Saving the workflow ](https://docs.n8n.io/advanced-ai/intro-tutorial/#9-saving-the-workflow)
 * [ Congratulations! ](https://docs.n8n.io/advanced-ai/intro-tutorial/#congratulations)
 * [ Next steps ](https://docs.n8n.io/advanced-ai/intro-tutorial/#next-steps)
...
[ ](https://github.com/n8n-io/n8n-docs/edit/main/docs/advanced-ai/intro-tutorial.md "")
...
An [AI agent](https://docs.n8n.io/glossary/#ai-agent) builds on [Large Language Models (LLMs)](https://docs.n8n.io/glossary/#large-language-model-llm), which generate text based on input by predicting the next word. While LLMs only process input to produce output, AI agents add goal-oriented functionality. They can use [tools](https://docs.n8n.io/glossary/#ai-tool), process their outputs, and make decisions to complete tasks and solve problems.
...
[![image showing the credentials dialog for OpenAI](https://docs.n8n.io/_images/advanced-ai/ai-tutorial-credentials.png)](https://docs.n8n.io/_images/advanced-ai/ai-tutorial-credentials.png)
 1. To add a new credential, click on the text which says 'Select credential'. An option to add a new credential will appear [![Screenshot showing create a new credential button](https://docs.n8n.io/_images/advanced-ai/ai-tutorial-create-credential.png)](https://docs.n8n.io/_images/advanced-ai/ai-tutorial-create-credential.png)
...
Now that the node is connected to the **Chat Trigger** and a chat model, we can test this part of the workflow.
 ...
 3. The log window displays the inputs to and outputs from the AI Agent. [![image showing a chat session in progress](https://docs.n8n.io/_images/advanced-ai/ai-intro-chat.png)](https://docs.n8n.io/_images/advanced-ai/ai-intro-chat.png)

Accessing the logs...
You can access the logs for the AI node even when you aren't using the chat interface. Open up the **AI Agent** node and click on the **Logs** tab in the right hand panel. [![screenshot showing the Logs tab in the AIAgent](https://docs.n8n.io/_images/advanced-ai/ai-intro-logs.png)](https://docs.n8n.io/_images/advanced-ai/ai-intro-logs.png)
...
The logs in the previous step reveal some extra data - the system prompt. This is the default message that the **AI Agent** primes the chat model with. From the log you can see this is set to "You are a helpful assistant". We can however change this prompt to alter the behavior of the chat model.
 ...
 3. Close the node and return to the chat window. Repeat your message and notice how the output has changed. [![image showing changed text for chat, now it rhymes; if you can believe that](https://docs.n8n.io/_images/advanced-ai/ai-intro-poet.png)](https://docs.n8n.io/_images/advanced-ai/ai-intro-poet.png)
...
The chat model is now giving us useful output, but there is something wrong with it which will become apparent when you try to have a conversation.
 ...
 2. Wait for the response, then type the message "What's my name?". The AI will not be able to tell you, however apologetic it may seem. The reason for this is we are not saving the context. The AI Agent has no [memory](https://docs.n8n.io/glossary/#ai-memory). [![image showing a conversation illustrating the above](https://docs.n8n.io/_images/advanced-ai/ai-intro-memory.png)](https://docs.n8n.io/_images/advanced-ai/ai-intro-memory.png)
...
Back to top [ Previous n8n Advanced AI Documentation and Guides ](https://docs.n8n.io/advanced-ai/) [ Next Overview ](https://docs.n8n.io/advanced-ai/langchain/overview/)
...
[Change cookie settings](https://docs.n8n.io/advanced-ai/intro-tutorial/#__consent)
