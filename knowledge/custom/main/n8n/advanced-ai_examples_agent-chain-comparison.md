 ...
 * Agents vs chains example [ Agents vs chains example ](https://docs.n8n.io/advanced-ai/examples/agent-chain-comparison/) Table of contents 
 * [ Key features ](https://docs.n8n.io/advanced-ai/examples/agent-chain-comparison/#key-features)
 * [ Using the example ](https://docs.n8n.io/advanced-ai/examples/agent-chain-comparison/#using-the-example)
...
[ ](https://github.com/n8n-io/n8n-docs/edit/main/docs/advanced-ai/examples/agent-chain-comparison.md "")
...
Back to top [ Previous What is an agent? ](https://docs.n8n.io/advanced-ai/examples/understand-agents/) [ Next What is memory? ](https://docs.n8n.io/advanced-ai/examples/understand-memory/)
...
[Change cookie settings](https://docs.n8n.io/advanced-ai/examples/agent-chain-comparison/#__consent)
