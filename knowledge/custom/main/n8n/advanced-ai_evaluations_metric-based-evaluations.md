 ...
 * Metric-based evaluations [ Metric-based evaluations ](https://docs.n8n.io/advanced-ai/evaluations/metric-based-evaluations/) Table of contents 
 * [ What are metric-based evaluations? ](https://docs.n8n.io/advanced-ai/evaluations/metric-based-evaluations/#what-are-metric-based-evaluations)
 * [ How it works ](https://docs.n8n.io/advanced-ai/evaluations/metric-based-evaluations/#how-it-works)
 * [ 1. Set up light evaluation ](https://docs.n8n.io/advanced-ai/evaluations/metric-based-evaluations/#1-set-up-light-evaluation)
 * [ 2. Calculate metrics ](https://docs.n8n.io/advanced-ai/evaluations/metric-based-evaluations/#2-calculate-metrics)
 * [ 3. Write metrics back to evaluation ](https://docs.n8n.io/advanced-ai/evaluations/metric-based-evaluations/#3-write-metrics-back-to-evaluation)
 * [ 4. Run evaluation and view results ](https://docs.n8n.io/advanced-ai/evaluations/metric-based-evaluations/#4-run-evaluation-and-view-results)
 ...
 * [ 4. Run evaluation and view results ](https://docs.n8n.io/advanced-ai/evaluations/metric-based-evaluations/#4-run-evaluation-and-view-results)
 ...
 2. [ Evaluations ](https://docs.n8n.io/advanced-ai/evaluations/overview/)

[ ](https://github.com/n8n-io/n8n-docs/edit/main/docs/advanced-ai/evaluations/metric-based-evaluations.md "")
...
n8n needs to know how to extract the metrics you calculated in step 2. Do this by adding an evaluation node with the ['Set metrics' operation](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-base.evaluation/#set-metrics) and mapping your metrics into it.
...
Back to top [ Previous Light evaluations ](https://docs.n8n.io/advanced-ai/evaluations/light-evaluations/) [ Next Tips and common issues ](https://docs.n8n.io/advanced-ai/evaluations/tips-and-common-issues/)
...
[Change cookie settings](https://docs.n8n.io/advanced-ai/evaluations/metric-based-evaluations/#__consent)
