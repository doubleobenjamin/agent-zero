 ...
 * Call an API to fetch data [ Call an API to fetch data ](https://docs.n8n.io/advanced-ai/examples/api-workflow-tool/) Table of contents 
 * [ Key features ](https://docs.n8n.io/advanced-ai/examples/api-workflow-tool/#key-features)
 * [ Using the example ](https://docs.n8n.io/advanced-ai/examples/api-workflow-tool/#using-the-example)
...
[ ](https://github.com/n8n-io/n8n-docs/edit/main/docs/advanced-ai/examples/api-workflow-tool.md "")
...
Back to top [ Previous Use Google Sheets as a data source ](https://docs.n8n.io/advanced-ai/examples/data-google-sheets/) [ Next Set a human fallback for AI workflows ](https://docs.n8n.io/advanced-ai/examples/human-fallback/)
...
[Change cookie settings](https://docs.n8n.io/advanced-ai/examples/api-workflow-tool/#__consent)
