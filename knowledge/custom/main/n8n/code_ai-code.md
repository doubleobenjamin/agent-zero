 ...
 * AI coding [ AI coding ](https://docs.n8n.io/code/ai-code/) Table of contents 
 * [ Use AI in the Code node ](https://docs.n8n.io/code/ai-code/#use-ai-in-the-code-node)
 * [ Usage limits ](https://docs.n8n.io/code/ai-code/#usage-limits)
 * [ Feature limits ](https://docs.n8n.io/code/ai-code/#feature-limits)
 * [ Writing good prompts ](https://docs.n8n.io/code/ai-code/#writing-good-prompts)
 * [ Example prompts ](https://docs.n8n.io/code/ai-code/#example-prompts)
 * [ Example 1: Find a piece of data inside a second dataset ](https://docs.n8n.io/code/ai-code/#example-1-find-a-piece-of-data-inside-a-second-dataset)
 * [ Example 2: Data transformation ](https://docs.n8n.io/code/ai-code/#example-2-data-transformation)
 * [ Example 3: Summarize data and create a Slack message ](https://docs.n8n.io/code/ai-code/#example-3-summarize-data-and-create-a-slack-message)
 * [ Reference incoming node data explicitly ](https://docs.n8n.io/code/ai-code/#reference-incoming-node-data-explicitly)
 * [ Related resources ](https://docs.n8n.io/code/ai-code/#related-resources)
 * [ Fixing the code ](https://docs.n8n.io/code/ai-code/#fixing-the-code)
...
[ ](https://github.com/n8n-io/n8n-docs/edit/main/docs/code/ai-code.md "")
...
```
| ```
constslackUser=$("Mock Slack").all()[0];
constnotionUsers=$input.all();
constslackUserEmail=slackUser.json.email;
constnotionUser=notionUsers.find(
(user)=>user.json.person&&user.json.person.email===slackUserEmail
);
returnnotionUser?[{json:{notionId:notionUser.json.id}}]:[];
...
constusernames=items.map((item)=>`"${item.json.username}"`);
constresult=usernames.join(", ");
...
constslackMessage=`*Summary of Submissions*\n
Ideas: ${ideaCount}\n
...
| ```
constitems=$input.all();
constnewItems=items.map((item)=>{
constfirstName=item.json.personal_info.first_name;
constjobTitle=item.json.work_info.job_title;
return{
json:{
firstName,
jobTitle,
...
Back to top [ Previous Using the Code node ](https://docs.n8n.io/code/code-node/) [ Next Overview ](https://docs.n8n.io/code/builtin/overview/)
...
[Change cookie settings](https://docs.n8n.io/code/ai-code/#__consent)
