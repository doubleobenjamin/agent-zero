 ...
 * Let AI specify tool parameters [ Let AI specify tool parameters ](https://docs.n8n.io/advanced-ai/examples/using-the-fromai-function/) Table of contents 
 * [ Let the model fill in the parameter ](https://docs.n8n.io/advanced-ai/examples/using-the-fromai-function/#let-the-model-fill-in-the-parameter)
 * [ Use the $fromAI() function ](https://docs.n8n.io/advanced-ai/examples/using-the-fromai-function/#use-the-fromai-function)
 * [ Parameters ](https://docs.n8n.io/advanced-ai/examples/using-the-fromai-function/#parameters)
 * [ Examples ](https://docs.n8n.io/advanced-ai/examples/using-the-fromai-function/#examples)
 * [ Templates ](https://docs.n8n.io/advanced-ai/examples/using-the-fromai-function/#templates)
 ...
 * [ Templates ](https://docs.n8n.io/advanced-ai/examples/using-the-fromai-function/#templates)
 ...
 2. [ Examples and concepts ](https://docs.n8n.io/advanced-ai/examples/introduction/)

$fromAI $fromAI() fromAI fromAI() [ ](https://github.com/n8n-io/n8n-docs/edit/main/docs/advanced-ai/examples/using-the-fromai-function.md "")
...
On activating this button, the [AI Agent](https://docs.n8n.io/glossary/#ai-agent) will fill in the expression for you, with no need for any further user input. The field itself is filled in with a message indicating that the parameter has been defined automatically by the model.
...
Back to top [ Previous Set a human fallback for AI workflows ](https://docs.n8n.io/advanced-ai/examples/human-fallback/) [ Next What is a vector database? ](https://docs.n8n.io/advanced-ai/examples/understand-vector-databases/)
...
[Change cookie settings](https://docs.n8n.io/advanced-ai/examples/using-the-fromai-function/#__consent)
