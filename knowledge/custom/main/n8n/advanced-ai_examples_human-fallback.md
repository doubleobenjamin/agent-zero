 ...
 * Set a human fallback for AI workflows [ Set a human fallback for AI workflows ](https://docs.n8n.io/advanced-ai/examples/human-fallback/) Table of contents 
 * [ Key features ](https://docs.n8n.io/advanced-ai/examples/human-fallback/#key-features)
 * [ Using the example ](https://docs.n8n.io/advanced-ai/examples/human-fallback/#using-the-example)
...
[ ](https://github.com/n8n-io/n8n-docs/edit/main/docs/advanced-ai/examples/human-fallback.md "")
...
Back to top [ Previous Call an API to fetch data ](https://docs.n8n.io/advanced-ai/examples/api-workflow-tool/) [ Next Let AI specify tool parameters ](https://docs.n8n.io/advanced-ai/examples/using-the-fromai-function/)
...
[Change cookie settings](https://docs.n8n.io/advanced-ai/examples/human-fallback/#__consent)
