 ...
 * [ Code in n8n ](https://docs.n8n.io/code/)
Code in n8n 
 * Expressions [ Expressions ](https://docs.n8n.io/code/expressions/) Table of contents 
 * [ Writing expressions ](https://docs.n8n.io/code/expressions/#writing-expressions)
 * [ Example: Get data from webhook body ](https://docs.n8n.io/code/expressions/#example-get-data-from-webhook-body)
 * [ Example: Writing longer JavaScript ](https://docs.n8n.io/code/expressions/#example-writing-longer-javascript)
 * [ Common issues ](https://docs.n8n.io/code/expressions/#common-issues)
...
[ ](https://github.com/n8n-io/n8n-docs/edit/main/docs/code/expressions.md "")
...
{{
functionexample(){
letend=DateTime.fromISO('2017-03-13');
letstart=DateTime.fromISO('2017-02-13');
letdiffInMonths=end.diff(start,'months');
returndiffInMonths.toObject();
}
example();
}}
...
Back to top [ Previous Code in n8n Documentation and Guides ](https://docs.n8n.io/code/) [ Next Using the Code node ](https://docs.n8n.io/code/code-node/)
...
[Change cookie settings](https://docs.n8n.io/code/expressions/#__consent)
