 ...
 * Populate a Pinecone vector database from a website [ Populate a Pinecone vector database from a website ](https://docs.n8n.io/advanced-ai/examples/vector-store-website/) Table of contents 
 * [ Key features ](https://docs.n8n.io/advanced-ai/examples/vector-store-website/#key-features)
 * [ Using the example ](https://docs.n8n.io/advanced-ai/examples/vector-store-website/#using-the-example)
 * [ API ](https://docs.n8n.io/api/)
API 
...
[ ](https://github.com/n8n-io/n8n-docs/edit/main/docs/advanced-ai/examples/vector-store-website.md "")
...
Back to top [ Previous What is a vector database? ](https://docs.n8n.io/advanced-ai/examples/understand-vector-databases/) [ Next n8n public REST API Documentation and Guides ](https://docs.n8n.io/api/)
...
[Change cookie settings](https://docs.n8n.io/advanced-ai/examples/vector-store-website/#__consent)
