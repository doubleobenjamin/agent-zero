 ...
 * Overview [ Overview ](https://docs.n8n.io/advanced-ai/evaluations/overview/) Table of contents 
 * [ What are evaluations? ](https://docs.n8n.io/advanced-ai/evaluations/overview/#what-are-evaluations)
 * [ Why is evaluation needed? ](https://docs.n8n.io/advanced-ai/evaluations/overview/#why-is-evaluation-needed)
 * [ Two types of evaluation ](https://docs.n8n.io/advanced-ai/evaluations/overview/#two-types-of-evaluation)
 * [ Light evaluation (pre-deployment) ](https://docs.n8n.io/advanced-ai/evaluations/overview/#light-evaluation-pre-deployment)
 * [ Metric-based evaluation (post-deployment) ](https://docs.n8n.io/advanced-ai/evaluations/overview/#metric-based-evaluation-post-deployment)
 * [ Comparison of evaluation types ](https://docs.n8n.io/advanced-ai/evaluations/overview/#comparison-of-evaluation-types)
 * [ Learn more ](https://docs.n8n.io/advanced-ai/evaluations/overview/#learn-more)
...
[ ](https://github.com/n8n-io/n8n-docs/edit/main/docs/advanced-ai/evaluations/overview.md "")
# Overview[#](https://docs.n8n.io/advanced-ai/evaluations/overview/#overview "Permanent link")
Not available in queue mode
Evaluations aren't yet supported for n8n instances running in [queue mode](https://docs.n8n.io/hosting/scaling/queue-mode/).
...
---|---|--- 
**Performance improvementswith each iteration** | Large | Small 
**Dataset size** | Small | Large 
**Dataset sources** | Hand-generatedAI-generatedOther | Production executionsAI-generatedOther 
...
Back to top [ Previous Use LangSmith with n8n ](https://docs.n8n.io/advanced-ai/langchain/langsmith/) [ Next Light evaluations ](https://docs.n8n.io/advanced-ai/evaluations/light-evaluations/)
...
[Change cookie settings](https://docs.n8n.io/advanced-ai/evaluations/overview/#__consent)
